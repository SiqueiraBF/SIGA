...
export function DrainageEmailSettingsModal({ onClose }: DrainageEmailSettingsModalProps) {
    ...
    const loadSettings = async () => {
        setIsLoading(true);
        const params = await systemService.getParameters(['email_drenagem_to', 'email_drenagem_cc']);
        setValue('email_drenagem_to', params['email_drenagem_to'] || '');
        setValue('email_drenagem_cc', params['email_drenagem_cc'] || '');
        setIsLoading(false);
    };
    ...
    const onSubmit = async (data: FormData) => {
        try {
            await Promise.all([
                systemService.updateParameter('email_drenagem_to', data.email_drenagem_to),
                systemService.updateParameter('email_drenagem_cc', data.email_drenagem_cc || '')
            ]);
