...
import { Droplet, Plus, Filter, Calendar, MapPin, ImageIcon, HelpCircle, Search, User, X, Settings as SettingsIcon, CheckCircle, AlertCircle, Clock } from 'lucide-react';
...
export function DrainageList() {
    ...
    async function loadData() {
        ...
        try {
            const filters: any = {};
            if (fazendaId) filters.fazenda_id = fazendaId;
    ...
    return (
        <div className="p-6 max-w-[1600px] mx-auto space-y-6 pb-20 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800">Drenagem de Postos</h1>
                    <p className="text-slate-500">Gerencie as aferições e drenagens dos tanques</p>
                </div>
