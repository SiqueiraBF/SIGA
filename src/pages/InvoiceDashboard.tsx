...
import { AlertTriangle, Clock, FileText, CheckCircle, Plus, Search, RefreshCw, History, Building2, Paperclip, Settings } from 'lucide-react';
    ...
    const fetchData = async () => {
        try {
            ...
            const [kpiData, listData] = await Promise.all([
                invoiceService.getKPIs(user?.fazenda_id),
                invoiceService.getInvoices(user?.fazenda_id, status)
            ]);
            setKpis(kpiData);
